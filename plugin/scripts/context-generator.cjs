"use strict";var ht=Object.create;var $=Object.defineProperty;var Ot=Object.getOwnPropertyDescriptor;var Nt=Object.getOwnPropertyNames;var Rt=Object.getPrototypeOf,At=Object.prototype.hasOwnProperty;var It=(r,e)=>{for(var t in e)$(r,t,{get:e[t],enumerable:!0})},ne=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Nt(e))!At.call(r,n)&&n!==t&&$(r,n,{get:()=>e[n],enumerable:!(s=Ot(e,n))||s.enumerable});return r};var M=(r,e,t)=>(t=r!=null?ht(Rt(r)):{},ne(e||!r||!r.__esModule?$(t,"default",{value:r,enumerable:!0}):t,r)),Ct=r=>ne($({},"__esModule",{value:!0}),r);var Yt={};It(Yt,{generateContext:()=>re});module.exports=Ct(Yt);var ft=M(require("path"),1),bt=require("os"),St=require("fs");var Te=require("bun:sqlite");var S=require("path"),pe=require("os"),le=require("fs");var ue=require("url");var A=require("fs"),w=require("path"),ae=require("os");var oe="bugfix,feature,refactor,discovery,decision,change",ie="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var I=class{static DEFAULTS={CLAUDE_MEM_MODEL:"claude-sonnet-4-5",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:"37777",CLAUDE_MEM_WORKER_HOST:"127.0.0.1",CLAUDE_MEM_WORKER_URL:"",CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_CHROMA_MODE:"auto",CLAUDE_MEM_CHROMA_URL:"http://localhost:8000",CLAUDE_MEM_PROVIDER:"claude",CLAUDE_MEM_GEMINI_API_KEY:"",CLAUDE_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",CLAUDE_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",CLAUDE_MEM_OPENROUTER_API_KEY:"",CLAUDE_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",CLAUDE_MEM_OPENROUTER_SITE_URL:"",CLAUDE_MEM_OPENROUTER_APP_NAME:"claude-mem",CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_OPENROUTER_MAX_TOKENS:"100000",CLAUDE_MEM_OLLAMA_URL:"http://localhost:11434",CLAUDE_MEM_OLLAMA_MODEL:"llama3.2",CLAUDE_MEM_OLLAMA_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_OLLAMA_MAX_TOKENS:"100000",CLAUDE_MEM_DATA_DIR:(0,w.join)((0,ae.homedir)(),".claude-mem"),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_MODE:"code",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_OBSERVATION_TYPES:oe,CLAUDE_MEM_CONTEXT_OBSERVATION_CONCEPTS:ie,CLAUDE_MEM_CONTEXT_FULL_COUNT:"5",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false",CLAUDE_MEM_GIT_REMOTE_PREFERENCE:"origin,upstream",CLAUDE_MEM_AGENT_DEFAULT_VISIBILITY:"project",CLAUDE_MEM_AGENT_KEY_EXPIRY_DAYS:"90",CLAUDE_MEM_AGENT_LOCKOUT_DURATION:"300",CLAUDE_MEM_AGENT_MAX_FAILED_ATTEMPTS:"5"};static getAllDefaults(){let e={...this.DEFAULTS};for(let t of Object.keys(this.DEFAULTS)){let s=process.env[t];s!==void 0&&(e[t]=s)}return e}static get(e){let t=process.env[e];return t!==void 0?t:this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){return this.get(e)==="true"}static loadFromFile(e){try{if(!(0,A.existsSync)(e)){let i=this.getAllDefaults();try{let a=(0,w.dirname)(e);(0,A.existsSync)(a)||(0,A.mkdirSync)(a,{recursive:!0}),(0,A.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.log("[SETTINGS] Created settings file with defaults:",e)}catch(a){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,a)}return i}let t=(0,A.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,A.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),console.log("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(i){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,i)}}let o={...this.DEFAULTS};for(let i of Object.keys(this.DEFAULTS)){let a=process.env[i];a!==void 0?o[i]=a:n[i]!==void 0&&(o[i]=n[i])}return o}catch(t){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t);let s={...this.DEFAULTS};for(let n of Object.keys(this.DEFAULTS)){let o=process.env[n];o!==void 0&&(s[n]=o)}return s}}};var C=require("fs"),v=require("path"),ce=require("os"),W=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(W||{}),de=process.env.CLAUDE_MEM_DATA_DIR||(0,v.join)((0,ce.homedir)(),".claude-mem"),Y=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(de,"logs");(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(de,"settings.json");if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=W[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let m="";if(n){let{sessionId:E,memorySessionId:T,correlationId:h,..._}=n;Object.keys(_).length>0&&(m=` {${Object.entries(_).map(([f,N])=>`${f}=${N}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${l}${s}${m}${u}`;if(this.logFilePath)try{(0,C.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=l?`${l[1].split("/").pop()}:${l[2]}`:"unknown",m={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},p=new Y;var Mt={};function Lt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,ue.fileURLToPath)(Mt.url))}var yt=Lt(),R=I.get("CLAUDE_MEM_DATA_DIR"),V=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,pe.homedir)(),".claude"),ss=(0,S.join)(R,"archives"),rs=(0,S.join)(R,"logs"),ns=(0,S.join)(R,"trash"),os=(0,S.join)(R,"backups"),is=(0,S.join)(R,"modes"),me=(0,S.join)(R,"settings.json"),_e=(0,S.join)(R,"claude-mem.db"),as=(0,S.join)(R,"vector-db"),ds=(0,S.join)(R,"observer-sessions"),cs=(0,S.join)(V,"settings.json"),ps=(0,S.join)(V,"commands"),ls=(0,S.join)(V,"CLAUDE.md");function Ee(r){(0,le.mkdirSync)(r,{recursive:!0})}function ge(){return(0,S.join)(yt,"..")}var F=class{db;constructor(e=_e){e!==":memory:"&&Ee(R),this.db=new Te.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.createMultiAgentColumns(),this.createProjectAliasesTable(),this.createConversationHistoryTable()}initializeSchema(){this.db.run(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_session ON pending_messages(session_db_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_status ON pending_messages(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_claude_session ON pending_messages(content_session_id)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(16,new Date().toISOString()),p.debug("DB","pending_messages table created successfully")}renameSessionIdColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(17))return;p.debug("DB","Checking session ID columns for semantic clarity rename");let t=0,s=(n,o,i)=>{let a=this.db.query(`PRAGMA table_info(${n})`).all(),d=a.some(u=>u.name===o);return a.some(u=>u.name===i)?!1:d?(this.db.run(`ALTER TABLE ${n} RENAME COLUMN ${o} TO ${i}`),p.debug("DB",`Renamed ${n}.${o} to ${i}`),!0):(p.warn("DB",`Column ${o} not found in ${n}, skipping rename`),!1)};s("sdk_sessions","claude_session_id","content_session_id")&&t++,s("sdk_sessions","sdk_session_id","memory_session_id")&&t++,s("pending_messages","claude_session_id","content_session_id")&&t++,s("observations","sdk_session_id","memory_session_id")&&t++,s("session_summaries","sdk_session_id","memory_session_id")&&t++,s("user_prompts","claude_session_id","content_session_id")&&t++,this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(17,new Date().toISOString()),t>0?p.debug("DB",`Successfully renamed ${t} session ID columns`):p.debug("DB","No session ID column renames needed (already up to date)")}repairSessionIdColumnRename(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(19)||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(19,new Date().toISOString())}addFailedAtEpochColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(20))return;this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="failed_at_epoch")||(this.db.run("ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"),p.debug("DB","Added failed_at_epoch column to pending_messages table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(20,new Date().toISOString())}createMultiAgentColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(21))return;p.debug("DB","Adding multi-agent columns"),this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='agents'").all().length===0&&(this.db.run(`
      ...
      `),this.db.run("CREATE INDEX IF NOT EXISTS idx_agents_department ON agents(department)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_agents_verified ON agents(verified)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_agents_api_key_prefix ON agents(api_key_prefix)")),this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='audit_log'").all().length===0&&(this.db.run(`
      ...
      `),this.db.run("CREATE INDEX IF NOT EXISTS idx_audit_log_agent ON audit_log(agent_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_audit_log_action ON audit_log(action)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_audit_log_created ON audit_log(created_at_epoch DESC)")),this.db.query("PRAGMA table_info(observations)").all().some(i=>i.name==="agent")||(this.db.run("ALTER TABLE observations ADD COLUMN agent TEXT DEFAULT 'legacy'"),this.db.run("ALTER TABLE observations ADD COLUMN department TEXT DEFAULT 'default'"),this.db.run("ALTER TABLE observations ADD COLUMN visibility TEXT DEFAULT 'project'"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observations_agent ON observations(agent)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observations_department ON observations(department)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observations_visibility ON observations(visibility)"),p.debug("DB","Added agent columns to observations")),this.db.query("PRAGMA table_info(session_summaries)").all().some(i=>i.name==="agent")||(this.db.run("ALTER TABLE session_summaries ADD COLUMN agent TEXT DEFAULT 'legacy'"),this.db.run("ALTER TABLE session_summaries ADD COLUMN department TEXT DEFAULT 'default'"),this.db.run("ALTER TABLE session_summaries ADD COLUMN visibility TEXT DEFAULT 'project'"),p.debug("DB","Added agent columns to session_summaries")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(21,new Date().toISOString()),p.debug("DB","Multi-agent columns migration completed")}createProjectAliasesTable(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(22))return;this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='project_aliases'").all().length===0&&(this.db.run(`
      ...
      `),this.db.run("CREATE INDEX IF NOT EXISTS idx_project_aliases_new_project ON project_aliases(new_project)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_project_aliases_created_at_epoch ON project_aliases(created_at_epoch)"),p.debug("DB","Created project_aliases table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(22,new Date().toISOString())}updateMemorySessionId(e,t){this.db.prepare(`
      UPDATE sdk_sessions
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),l=new Date(d).toISOString();return this.db.transaction(()=>{let m=[],g=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let T of s){let h=g.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),o||null,i,l,d);m.push(Number(h.lastInsertRowid))}let E=null;if(n){let h=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,l,d);E=Number(h.lastInsertRowid)}return{observationIds:m,summaryId:E,createdAtEpoch:d}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,l){let u=l??Date.now(),m=new Date(u).toISOString();return this.db.transaction(()=>{let E=[],T=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let b of s){let f=T.run(e,t,b.type,b.title,b.subtitle,JSON.stringify(b.facts),b.narrative,JSON.stringify(b.concepts),JSON.stringify(b.files_read),JSON.stringify(b.files_modified),a||null,d,m,u);E.push(Number(f.lastInsertRowid))}let h;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,m,u);h=Number(f.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(u,o),{observationIds:E,summaryId:h,createdAtEpoch:u}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),l=[...e],u=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&l.push(o),this.db.prepare(`
    ...
    `).all(...l)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,l;if(e!==null){let _=`
      ...
      `,b=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let f=this.db.prepare(_).all(e,...a,s+1),N=this.db.prepare(b).all(e,...a,n+1);if(f.length===0&&N.length===0)return{observations:[],sessions:[],prompts:[]};d=f.length>0?f[f.length-1].created_at_epoch:t,l=N.length>0?N[N.length-1].created_at_epoch:t}catch(f){return p.error("DB","Error getting boundary observations",void 0,{error:f,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let _=`
      ...
      `,b=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let f=this.db.prepare(_).all(t,...a,s),N=this.db.prepare(b).all(t,...a,n+1);if(f.length===0&&N.length===0)return{observations:[],sessions:[],prompts:[]};d=f.length>0?f[f.length-1].created_at_epoch:t,l=N.length>0?N[N.length-1].created_at_epoch:t}catch(f){return p.error("DB","Error getting boundary timestamps",void 0,{error:f,project:o}),{observations:[],sessions:[],prompts:[]}}}let u=`
      SELECT *
      FROM observations
...
`)){let n=s.match(/^(\S+)\s+(\S+)\s+\(fetch\)/);n&&!t.has(n[1])&&(t.add(n[1]),e.push({name:n[1],url:n[2]}))}return e}function Ut(r,e=vt){if(r.length===0)return null;for(let t of e){let s=r.find(n=>n.name===t);if(s)return s}return r[0]}function kt(r){let e=Oe.default.join(r,".git");if(!(0,L.existsSync)(e))return null;try{let t=(0,L.statSync)(e);if(t.isDirectory())return r;if(t.isFile()){let n=(0,L.readFileSync)(e,"utf-8").trim().match(/^gitdir:\s*(.+)$/);if(n){let o=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]/);if(o)return o[1]}}}catch{}return null}function Ne(r,e){if(!be())return null;let t=kt(r);if(!t)return null;try{let s=(0,he.execSync)("git remote -v",{cwd:t,encoding:"utf-8",stdio:["pipe","pipe","pipe"],timeout:5e3}),n=xt(s),o=e??Se(),i=Ut(n,o);return i?Dt(i.url):(p.debug("GIT_REMOTE","No remotes configured",{cwd:r}),null)}catch(s){return p.debug("GIT_REMOTE","Failed to get remote",{cwd:r,error:s}),null}}function Ae(r){if(!r||r.trim()==="")return p.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=Ne(r);if(e)return p.debug("PROJECT_NAME","Using git remote identifier",{cwd:r,remoteId:e}),e;let t=Re.default.basename(r);if(t===""){if(process.platform==="win32"){let n=r.match(/^([A-Z]):\\/i);if(n){let i=`drive-${n[1].toUpperCase()}`;return p.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:i}),i}}return p.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return t}var x=require("fs"),P=require("path");var O=class r{static instance=null;activeMode=null;modesDir;constructor(){let e=ge(),t=[(0,P.join)(e,"modes"),(0,P.join)(e,"..","plugin","modes")],s=t.find(n=>(0,x.existsSync)(n));this.modesDir=s||t[0]}static getInstance(){return r.instance||(r.instance=new r),r.instance}parseInheritance(e){let t=e.split("--");if(t.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(t.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:t[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,t){let s={...e};for(let n in t){let o=t[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?s[n]=this.deepMerge(i,o):s[n]=o}return s}loadModeFile(e){let t=(0,P.join)(this.modesDir,`${e}.json`);if(!(0,x.existsSync)(t))throw new Error(`Mode file not found: ${t}`);let s=(0,x.readFileSync)(t,"utf-8");return JSON.parse(s)}loadMode(e){let t=this.parseInheritance(e);if(!t.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,p.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(l=>l.id),concepts:d.observation_concepts.map(l=>l.id)}),d}catch{if(p.warn("SYSTEM",`Mode file not found: ${e}, falling back to 'code'`),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:s,overrideId:n}=t,o;try{o=this.loadMode(s)}catch{p.warn("SYSTEM",`Parent mode '${s}' not found for ${e}, falling back to 'code'`),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),p.debug("SYSTEM",`Loaded override file: ${n} for parent ${s}`)}catch{return p.warn("SYSTEM",`Override file '${n}' not found, using parent mode '${s}' only`),this.activeMode=o,o}if(!i)return p.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${s}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,p.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${s} + ${n})`,void 0,{parent:s,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getObservationConcepts(){return this.getActiveMode().observation_concepts}getTypeIcon(e){return this.getObservationTypes().find(s=>s.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(s=>s.id===e)?.work_emoji||"\u{1F4DD}"}validateType(e){return this.getObservationTypes().some(t=>t.id===e)}getTypeLabel(e){return this.getObservationTypes().find(s=>s.id===e)?.label||e}};function K(){let r=I.loadFromFile(me),e=r.CLAUDE_MEM_MODE,t=e==="code"||e.startsWith("code--"),s,n;if(t)s=new Set(r.CLAUDE_MEM_CONTEXT_OBSERVATION_TYPES.split(",").map(o=>o.trim()).filter(Boolean)),n=new Set(r.CLAUDE_MEM_CONTEXT_OBSERVATION_CONCEPTS.split(",").map(o=>o.trim()).filter(Boolean));else{let o=O.getInstance().getActiveMode();s=new Set(o.observation_types.map(i=>i.id)),n=new Set(o.observation_concepts.map(i=>i.id))}return{totalObservationCount:parseInt(r.CLAUDE_MEM_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(r.CLAUDE_MEM_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(r.CLAUDE_MEM_CONTEXT_SESSION_COUNT,10),showReadTokens:r.CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:r.CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:r.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:r.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:s,observationConcepts:n,fullObservationField:r.CLAUDE_MEM_CONTEXT_FULL_FIELD,showLastSummary:r.CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:r.CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE==="true"}}var c={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},Ie=4,q=1;function J(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/Ie)}function Q(r){let e=r.length,t=r.reduce((i,a)=>i+J(a),0),s=r.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=s-t,o=s>0?Math.round(n/s*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:s,savings:n,savingsPercent:o}}function $t(r){return O.getInstance().getWorkEmoji(r)}function y(r,e){let t=J(r),s=r.discovery_tokens||0,n=$t(r.type),o=s>0?`${n} ${s.toLocaleString()}`:"-";return{readTokens:t,discoveryTokens:s,discoveryDisplay:o,workEmoji:n}}function X(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}var Ce=M(require("path"),1),Le=require("os"),j=require("fs");function z(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(",");return r.db.prepare(`
  ...
  `).all(e,...s,...o,t.totalObservationCount)}function Z(r,e,t){return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+q)}function ye(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
...
`}function at(r,e,t,s){let n=[];return s?n.push(...Ke(r)):n.push(...Ue(r)),s?n.push(...qe()):n.push(...ke()),s?n.push(...Je()):n.push(...$e()),s?n.push(...Qe()):n.push(...we()),X(t)&&(s?n.push(...ze(e,t)):n.push(...Fe(e,t))),n}var se=M(require("path"),1);function H(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return p.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ct(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function pt(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function lt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function dt(r,e){return se.default.isAbsolute(r)?se.default.relative(e,r):r}function ut(r,e,t){let s=H(r);if(s.length>0)return dt(s[0],e);if(t){let n=H(t);if(n.length>0)return dt(n[0],e)}return"General"}function Pt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=lt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Xt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?H(r.facts).join(`
`):null}function jt(r,e,t,s,n,o){let i=[];o?i.push(...Ze(r)):i.push(...Pe(r));let a=null,d="",l=!1;for(let u of e)if(u.type==="summary"){l&&(i.push(""),l=!1,a=null,d="");let m=u.data,g=ct(m.displayTime);o?i.push(...rt(m,g)):i.push(...Be(m,g))}else{let m=u.data,g=ut(m.files_modified,n,m.files_read),E=pt(m.created_at),T=E!==d,h=T?E:"";d=E;let _=t.has(m.id);if(g!==a&&(l&&i.push(""),o?i.push(...et(g)):i.push(...Xe(g)),a=g,l=!0),_){let b=Xt(m,s);o?i.push(...st(m,E,T,b,s)):(l&&!o&&(i.push(""),l=!1),i.push(...Ge(m,h,b,s)),a=null)}else o?i.push(tt(m,E,T,s)):i.push(je(m,h,s))}return l&&i.push(""),i}function mt(r,e,t,s,n){let o=[],i=Pt(r);for(let[a,d]of i)o.push(...jt(a,d,e,t,s,n));return o}function _t(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Et(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,c.blue)),t.push(...k("Learned",r.learned,c.yellow)),t.push(...k("Completed",r.completed,c.green)),t.push(...k("Next Steps",r.next_steps,c.magenta))):(t.push(...U("Investigated",r.investigated)),t.push(...U("Learned",r.learned)),t.push(...U("Completed",r.completed)),t.push(...U("Next Steps",r.next_steps))),t}function gt(r,e){return e?nt(r):He(r)}function Tt(r,e,t){return!X(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ot(r.totalDiscoveryTokens,r.totalReadTokens):We(r.totalDiscoveryTokens,r.totalReadTokens)}var Gt=ft.default.join((0,bt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Bt(){try{return new F}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,St.unlinkSync)(Gt)}catch(e){p.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return p.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ht(r,e){return e?it(r):Ye(r)}function Wt(r,e,t,s,n,o,i){let a=[],d=Q(e);a.push(...at(r,d,s,i));let l=t.slice(0,s.sessionCount),u=ve(l,t),m=te(e,u),g=De(e,s.fullObservationCount);a.push(...mt(m,g,s,n,i));let E=t[0],T=e[0];_t(s,E,T)&&a.push(...Et(E,i));let h=ee(e,s,o,n);return a.push(...gt(h,i)),a.push(...Tt(d,s,i)),a.join(`
`).trimEnd()}async function re(r,e=!1){let t=K(),s=r?.cwd??process.cwd(),n=Ae(s),o=r?.projects||[n],i=Bt();if(!i)return"";try{let a=o.length>1?ye(i,o,t):z(i,n,t),d=o.length>1?Me(i,o,t):Z(i,n,t);return a.length===0&&d.length===0?Ht(n,e):Wt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
