"use strict";var bt=Object.create;var $=Object.defineProperty;var Ot=Object.getOwnPropertyDescriptor;var Rt=Object.getOwnPropertyNames;var Ct=Object.getPrototypeOf,At=Object.prototype.hasOwnProperty;var Nt=(r,e)=>{for(var t in e)$(r,t,{get:e[t],enumerable:!0})},ne=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Rt(e))!At.call(r,n)&&n!==t&&$(r,n,{get:()=>e[n],enumerable:!(s=Ot(e,n))||s.enumerable});return r};var L=(r,e,t)=>(t=r!=null?bt(Ct(r)):{},ne(e||!r||!r.__esModule?$(t,"default",{value:r,enumerable:!0}):t,r)),It=r=>ne($({},"__esModule",{value:!0}),r);var Yt={};Nt(Yt,{generateContext:()=>re});module.exports=It(Yt);var ft=L(require("path"),1),St=require("os"),ht=require("fs");var Te=require("bun:sqlite");var h=require("path"),pe=require("os"),le=require("fs");var ue=require("url");var A=require("fs"),w=require("path"),ae=require("os");var oe="bugfix,feature,refactor,discovery,decision,change",ie="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var N=class{static DEFAULTS={CLAUDE_MEM_MODEL:"claude-sonnet-4-5",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:"37777",CLAUDE_MEM_WORKER_HOST:"127.0.0.1",CLAUDE_MEM_WORKER_URL:"",CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_CHROMA_MODE:"auto",CLAUDE_MEM_CHROMA_URL:"http://localhost:8000",CLAUDE_MEM_PROVIDER:"claude",CLAUDE_MEM_GEMINI_API_KEY:"",CLAUDE_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",CLAUDE_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",CLAUDE_MEM_OPENROUTER_API_KEY:"",CLAUDE_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",CLAUDE_MEM_OPENROUTER_SITE_URL:"",CLAUDE_MEM_OPENROUTER_APP_NAME:"claude-mem",CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_OPENROUTER_MAX_TOKENS:"100000",CLAUDE_MEM_OLLAMA_URL:"http://localhost:11434",CLAUDE_MEM_OLLAMA_MODEL:"llama3.2",CLAUDE_MEM_OLLAMA_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_OLLAMA_MAX_TOKENS:"100000",CLAUDE_MEM_DATA_DIR:(0,w.join)((0,ae.homedir)(),".claude-mem"),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_MODE:"code",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"true",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_OBSERVATION_TYPES:oe,CLAUDE_MEM_CONTEXT_OBSERVATION_CONCEPTS:ie,CLAUDE_MEM_CONTEXT_FULL_COUNT:"5",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false",CLAUDE_MEM_GIT_REMOTE_PREFERENCE:"origin,upstream",CLAUDE_MEM_VERBOSITY:"standard",CLAUDE_MEM_AGENT_DEFAULT_VISIBILITY:"project",CLAUDE_MEM_AGENT_KEY_EXPIRY_DAYS:"90",CLAUDE_MEM_AGENT_LOCKOUT_DURATION:"300",CLAUDE_MEM_AGENT_MAX_FAILED_ATTEMPTS:"5",CLAUDE_MEM_SEARCH_RECENCY_DAYS:"90",CLAUDE_MEM_AUTO_MEMORY:"enabled"};static getAllDefaults(){let e={...this.DEFAULTS};for(let t of Object.keys(this.DEFAULTS)){let s=process.env[t];s!==void 0&&(e[t]=s)}return e}static get(e){let t=process.env[e];return t!==void 0?t:this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){return this.get(e)==="true"}static loadFromFile(e){try{if(!(0,A.existsSync)(e)){let i=this.getAllDefaults();try{let a=(0,w.dirname)(e);(0,A.existsSync)(a)||(0,A.mkdirSync)(a,{recursive:!0}),(0,A.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.log("[SETTINGS] Created settings file with defaults:",e)}catch(a){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,a)}return i}let t=(0,A.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,A.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),console.log("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(i){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,i)}}let o={...this.DEFAULTS};for(let i of Object.keys(this.DEFAULTS)){let a=process.env[i];a!==void 0?o[i]=a:n[i]!==void 0&&(o[i]=n[i])}return o}catch(t){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t);let s={...this.DEFAULTS};for(let n of Object.keys(this.DEFAULTS)){let o=process.env[n];o!==void 0&&(s[n]=o)}return s}}};var I=require("fs"),v=require("path"),ce=require("os"),W=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(W||{}),de=process.env.CLAUDE_MEM_DATA_DIR||(0,v.join)((0,ce.homedir)(),".claude-mem"),Y=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(de,"logs");(0,I.existsSync)(e)||(0,I.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(de,"settings.json");if((0,I.existsSync)(e)){let t=(0,I.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=W[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let m="";if(n){let{sessionId:E,memorySessionId:T,correlationId:b,..._}=n;Object.keys(_).length>0&&(m=` {${Object.entries(_).map(([f,R])=>`${f}=${R}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${l}${s}${m}${u}`;if(this.logFilePath)try{(0,I.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=l?`${l[1].split("/").pop()}:${l[2]}`:"unknown",m={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},p=new Y;var Lt={};function Mt(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,ue.fileURLToPath)(Lt.url))}var yt=Mt(),C=N.get("CLAUDE_MEM_DATA_DIR"),V=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,pe.homedir)(),".claude"),ss=(0,h.join)(C,"archives"),rs=(0,h.join)(C,"logs"),ns=(0,h.join)(C,"trash"),os=(0,h.join)(C,"backups"),is=(0,h.join)(C,"modes"),me=(0,h.join)(C,"settings.json"),_e=(0,h.join)(C,"claude-mem.db"),as=(0,h.join)(C,"vector-db"),ds=(0,h.join)(C,"observer-sessions"),cs=(0,h.join)(V,"settings.json"),ps=(0,h.join)(V,"commands"),ls=(0,h.join)(V,"CLAUDE.md");function Ee(r){(0,le.mkdirSync)(r,{recursive:!0})}function ge(){return(0,h.join)(yt,"..")}var F=class{db;constructor(e=_e){e!==":memory:"&&Ee(C),this.db=new Te.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.createProjectAliasesTable(),this.createConversationHistoryTable()}initializeSchema(){this.db.run(`
...
`}function at(r,e,t,s){let n=[];return s?n.push(...Ke(r)):n.push(...Ue(r)),s?n.push(...qe()):n.push(...ke()),s?n.push(...Je()):n.push(...$e()),s?n.push(...ze()):n.push(...we()),j(t)&&(s?n.push(...Qe(e,t)):n.push(...Fe(e,t))),n}var se=L(require("path"),1);function H(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return p.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ct(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function pt(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function lt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function dt(r,e){return se.default.isAbsolute(r)?se.default.relative(e,r):r}function ut(r,e,t){let s=H(r);if(s.length>0)return dt(s[0],e);if(t){let n=H(t);if(n.length>0)return dt(n[0],e)}return"General"}function Pt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=lt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function jt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?H(r.facts).join(`
`):null}function Xt(r,e,t,s,n,o){let i=[];o?i.push(...Ze(r)):i.push(...Pe(r));let a=null,d="",l=!1;for(let u of e)if(u.type==="summary"){l&&(i.push(""),l=!1,a=null,d="");let m=u.data,g=ct(m.displayTime);o?i.push(...rt(m,g)):i.push(...Be(m,g))}else{let m=u.data,g=ut(m.files_modified,n,m.files_read),E=pt(m.created_at),T=E!==d,b=T?E:"";d=E;let _=t.has(m.id);if(g!==a&&(l&&i.push(""),o?i.push(...et(g)):i.push(...je(g)),a=g,l=!0),_){let S=jt(m,s);o?i.push(...st(m,E,T,S,s)):(l&&!o&&(i.push(""),l=!1),i.push(...Ge(m,b,S,s)),a=null)}else o?i.push(tt(m,E,T,s)):i.push(Xe(m,b,s))}return l&&i.push(""),i}function mt(r,e,t,s,n){let o=[],i=Pt(r);for(let[a,d]of i)o.push(...Xt(a,d,e,t,s,n));return o}function _t(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Et(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,c.blue)),t.push(...k("Learned",r.learned,c.yellow)),t.push(...k("Completed",r.completed,c.green)),t.push(...k("Next Steps",r.next_steps,c.magenta))):(t.push(...U("Investigated",r.investigated)),t.push(...U("Learned",r.learned)),t.push(...U("Completed",r.completed)),t.push(...U("Next Steps",r.next_steps))),t}function gt(r,e){return e?nt(r):He(r)}function Tt(r,e,t){return!j(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?ot(r.totalDiscoveryTokens,r.totalReadTokens):We(r.totalDiscoveryTokens,r.totalReadTokens)}var Gt=ft.default.join((0,St.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Bt(){try{return new F}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,ht.unlinkSync)(Gt)}catch(e){p.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return p.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ht(r,e){return e?it(r):Ye(r)}function Wt(r,e,t,s,n,o,i){let a=[],d=z(e);a.push(...at(r,d,s,i));let l=t.slice(0,s.sessionCount),u=ve(l,t),m=te(e,u),g=De(e,s.fullObservationCount);a.push(...mt(m,g,s,n,i));let E=t[0],T=e[0];_t(s,E,T)&&a.push(...Et(E,i));let b=ee(e,s,o,n);return a.push(...gt(b,i)),a.push(...Tt(d,s,i)),a.join(`
`).trimEnd()}async function re(r,e=!1){let t=K(),s=r?.cwd??process.cwd(),n=Ae(s),o=r?.projects||[n],i=Bt();if(!i)return"";try{let a=o.length>1?ye(i,o,t):Q(i,n,t),d=o.length>1?Le(i,o,t):Z(i,n,t);return a.length===0&&d.length===0?Ht(n,e):Wt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
